"""
Voice management API endpoints - v2 (CosyVoice2)
"""
...
router = APIRouter(prefix="/voices", tags=["Voice Management (v2)"])
...
async def create_voice(
    ...
    try:
        ...
        logger.info(f"Created voice (v2): {voice_id}")
...
async def update_voice(
    ...
    try:
        ...
        logger.info(f"Updated voice (v2): {voice_id}")
        return VoiceResponse(**voice.dict())
...
async def delete_voice(
    ...
    try:
        ...
        logger.info(f"Deleted voice (v2): {voice_id}")
