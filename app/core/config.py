...
try:
    ...
    try:
        ...
        try:
            ...
            print("Using legacy BaseSettings - may not work with Pydantic v2")
        except ImportError:
            raise ImportError(
...
class Settings(BaseSettings):
    ...
    # Model settings - Chatterbox
    CHATTERBOX_MODEL_TYPE: str = Field(
        default="multilingual",
        env="CHATTERBOX_MODEL_TYPE",
        description="Chatterbox model type: turbo, multilingual, or original"
    )
