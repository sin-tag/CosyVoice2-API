...
pip install WeTextProcessing>=1.0.3 || echo [WARNING] WeTextProcessing installation failed, but wetext fallback is available
...
if exist "requirements.txt" (
    ...
    pip install -r requirements.txt || echo [WARNING] Some dependencies from requirements.txt may have failed to install
)
